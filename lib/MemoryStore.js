...
function MemoryStore(name) {
  ...
  this.privateStore = new PrivateStore(this.name);
}
...
MemoryStore.prototype.privateGet = function() {
  this.privateStore.get.apply(this.privateStore, arguments)
}

MemoryStore.prototype.privateSet = function() {
  this.privateStore.set.apply(this.privateStore, arguments)
}

MemoryStore.prototype.privateRemove = function() {
  this.privateStore.remove.apply(this.privateStore, arguments)
}

function PrivateStore(name) {
  this.name = "__private_" + name
  _root.set(new Key(this.name), null)
}

PrivateStore.prototype.get = MemoryStore.prototype.get
PrivateStore.prototype.set = MemoryStore.prototype.set
PrivateStore.prototype.remove = MemoryStore.prototype.remove
